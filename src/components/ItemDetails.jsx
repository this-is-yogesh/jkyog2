      ...
      <Box display="flex" flexWrap="wrap" columnGap="40px">
        ...
        <Box flex="1 1 50%" mb="40px">
          ...
          <Box m="65px 0 25px 0">
            ...
            <Typography sx={{ mt: "20px" }}     dangerouslySetInnerHTML={{ __html: updateditem.body_html }}>
          ...
          <Box >
            ...
            <Typography alignItems="flex-end">PRICE - ${updateditem?.variants[0].price}</Typography>
          </Box>
        </Box>
        </>)}
      </Box>
